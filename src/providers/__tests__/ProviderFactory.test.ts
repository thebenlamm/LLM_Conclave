...
describe('ProviderFactory', () => {
  ...
  describe('OpenAI model detection', () => {
    it('should create OpenAIProvider for gpt-4o', () => {
      ...
      expect(OpenAIProvider).toHaveBeenCalledWith('gpt-4o', undefined, undefined);
      expect(provider.type).toBe('openai');
    });

    it('should create OpenAIProvider for gpt-4-turbo', () => {
      const provider = ProviderFactory.createProvider('gpt-4-turbo');
      expect(OpenAIProvider).toHaveBeenCalledWith('gpt-4-turbo', undefined, undefined);
      expect(provider.type).toBe('openai');
    });

    it('should create OpenAIProvider for gpt-3.5-turbo', () => {
      const provider = ProviderFactory.createProvider('gpt-3.5-turbo');
      expect(OpenAIProvider).toHaveBeenCalledWith('gpt-3.5-turbo', undefined, undefined);
      expect(provider.type).toBe('openai');
    });
  ...
  describe('Claude model detection', () => {
    it('should create ClaudeProvider for full model name', () => {
      ...
      expect(ClaudeProvider).toHaveBeenCalledWith('claude-3-5-sonnet-20241022', undefined, undefined, undefined);
    ...
    it('should expand "sonnet" shorthand to full model name', () => {
      ...
      expect(ClaudeProvider).toHaveBeenCalledWith('claude-sonnet-4-5', undefined, undefined, undefined);
      expect(provider.type).toBe('claude');
    });
    ...
    it('should expand "opus" shorthand to full model name', () => {
      ...
      expect(ClaudeProvider).toHaveBeenCalledWith('claude-opus-4-5', undefined, undefined, undefined);
      expect(provider.type).toBe('claude');
    });
    ...
    it('should expand "haiku" shorthand to full model name', () => {
      ...
      expect(ClaudeProvider).toHaveBeenCalledWith('claude-haiku-4-5', undefined, undefined, undefined);
      expect(provider.type).toBe('claude');
    });
    ...
    it('should pass contextEditing option to ClaudeProvider', () => {
      ...
      expect(ClaudeProvider).toHaveBeenCalledWith('claude-sonnet-4-5', undefined, { contextEditing: true }, undefined);
    });
  });
  ...
  describe('Grok model detection', () => {
    it('should create GrokProvider for grok-beta', () => {
      ...
      expect(GrokProvider).toHaveBeenCalledWith('grok-beta', undefined, undefined);
    ...
    it('should create GrokProvider for grok-3', () => {
      ...
      expect(GrokProvider).toHaveBeenCalledWith('grok-3', undefined, undefined);
      expect(provider.type).toBe('grok');
    });
  ...
  describe('Gemini model detection', () => {
    it('should create GeminiProvider for full model name', () => {
      ...
      expect(GeminiProvider).toHaveBeenCalledWith('gemini-2.5-pro', undefined, undefined);
    ...
    it('should expand "gemini-flash" shorthand to gemini-2.0-flash', () => {
      ...
      expect(GeminiProvider).toHaveBeenCalledWith('gemini-2.0-flash', undefined, undefined);
      expect(provider.type).toBe('gemini');
    });
  ...
  describe('Mistral model detection', () => {
    it('should create MistralProvider for mistral-large-latest', () => {
      ...
      expect(MistralProvider).toHaveBeenCalledWith('mistral-large-latest', undefined, undefined);
    ...
    it('should create MistralProvider for mistral-small-latest', () => {
      ...
      expect(MistralProvider).toHaveBeenCalledWith('mistral-small-latest', undefined, undefined);
      expect(provider.type).toBe('mistral');
    });

    it('should create MistralProvider for codestral-latest', () => {
      const provider = ProviderFactory.createProvider('codestral-latest');
      expect(MistralProvider).toHaveBeenCalledWith('codestral-latest', undefined, undefined);
      expect(provider.type).toBe('mistral');
    });

 ...
 */
export const AGENT_ROLES: Record<string, any> = {
  Brand_Architect: {
 ...
 */
export function getResolutionMode(taskType: string): string {
 ...
 */
export function getDecisionMakers(): string[] {
 ...
 */
export function requiresValidation(task: string): boolean {

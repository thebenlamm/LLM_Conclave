...
class SessionManager {
     ...
     */
    async updateIndexManifest(session) {
     ...
     */
    createSessionManifest(mode, task, agents, conversationHistory, result, judge, projectContext) {
     ...
     */
    formatSessionSummary(session, index) {

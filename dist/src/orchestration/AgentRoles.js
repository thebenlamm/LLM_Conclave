...
exports.RESOLUTION_MODES = exports.AGENT_ROLES = exports.AGENT_TYPES = void 0;
exports.getResolutionMode = getResolutionMode;
exports.getDecisionMakers = getDecisionMakers;
...
exports.AGENT_ROLES = {
    Brand_Architect: {
        type: exports.AGENT_TYPES.DECISION_MAKER,
        domains: [
            'naming',
            'messaging',
            'aesthetics',
    ...
    Compliance: {
        type: exports.AGENT_TYPES.VALIDATOR,
        domains: [
            'legal requirements',
...
function getResolutionMode(taskType) {
    ...
    if (brandFirst.some(keyword => taskLower.includes(keyword))) {
        return exports.RESOLUTION_MODES.BRAND_FIRST;
    }
    if (operationsFirst.some(keyword => taskLower.includes(keyword))) {
        return exports.RESOLUTION_MODES.OPERATIONS_FIRST;
    }
    if (marketFirst.some(keyword => taskLower.includes(keyword))) {
        return exports.RESOLUTION_MODES.MARKET_FIRST;
    }
...
function getDecisionMakers() {
    return Object.entries(exports.AGENT_ROLES)
        .filter(([_, role]) => role.type === exports.AGENT_TYPES.DECISION_MAKER)
        .map(([name, _]) => name);
}
/**
...
function getValidators() {
    return Object.entries(exports.AGENT_ROLES)
        .filter(([_, role]) => role.type === exports.AGENT_TYPES.VALIDATOR)
        .map(([name, _]) => name);
}
/**

...
const StatusDisplay_1 = __importDefault(require("./StatusDisplay"));
/**
 * InteractiveSession - Claude CLI-style interactive REPL
 */
class InteractiveSession {
    constructor(config, projectId = null) {
        ...
        this.orchestrator = new Orchestrator_1.default(config, null); // MemoryManager is optional in Orchestrator constructor, passing null for now or update if needed
        this.display = new StatusDisplay_1.default();
